...
.. figure:: images/190912_beams_chan_9-1024x990.png
  :align: center
  :width: 400
  :alt: Relative flux error
  :name: beams_chan9
...
The provided primary beam images are created at 100” resolution and should be regridded to match the images/cubes they are used to correct. In addition, they can be applied to other frequencies by scaling the cell size (cdelt1 and cdelt2 keywords) linearly with frequency (see subsection ":ref:`Beam size change with frequency`" in ":ref:`Drift scan method`" for the scaling) before regridding to match the data product of interest.
